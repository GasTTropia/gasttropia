...
if (App::db()->getUtility()->tableExists('@blog_post')) {
    ...
    $posts = [
        [
            'slug' => 'let-me-introduce-gasttropia',
            'title' => 'Let me introduce GasTTropia',
            'data' => '{"image": {"alt":"Let me introduce GasTTropia","src":"storage/theme-one/blog-07.jpg"}}'
        ],
        [
        ...
        [
            'slug' => 'use-gasttropia-for-any-project',
            'title' => 'Use GasTTropia for any project',
            'data' => '{"image": {"alt":"Use GasTTropia for any project","src":"storage/theme-one/blog-04.jpg"}}'
        ],
        [
            'slug' => 'inside-gasttropia',
            'title' => 'Inside GasTTropia',
            'data' => '{"image": {"alt":"Inside GasTTropia","src":"storage/theme-one/about-05.jpg"}}',
            'comments' => [
