...
App::db()->insert('@system_widget', ['title' => 'Hello, I\'m Kronos', 'type' => 'system/text', 'status' => 1, 'nodes' => 1, 'data' => '{"content":"<h1 class=\"uk-heading-large uk-margin-large-bottom\">Hello, I\'m Kronos,<br class=\"uk-visible@s\"> your new favorite CMS.<\/h1>\n\n<a class=\"uk-button uk-button-default uk-button-large\" href=\"http:\/\/www.ttags.de\/kronos\">Get started<\/a>"}']);

App::db()->insert('@system_widget', ['title' => 'Powered by Kronos', 'type' => 'system/text', 'status' => 1, 'data' => '{"content":"<ul class=\"uk-grid-medium uk-flex uk-flex-center\" uk-grid>\n<li><a href=\"https:\/\/github.com\/ttags\/kronos\" class=\"uk-icon-link\" uk-icon=\"github\" ratio=\"1.25\"><\/a><\/li>\n<li><a href=\"https:\/\/twitter.com\/kronos\" class=\"uk-icon-link\" uk-icon=\"twitter\" ratio=\"1.25\"><\/a><\/li>\n<\/ul>\n\n<p>Powered by <a href=\"https:\/\/ttags.de\">TTags<\/a><\/p>"}']);
